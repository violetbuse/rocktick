...
INSERT INTO `new_executions` (`job_id`, `success`, `lock_nonce`, `response_id`, `response_error`, `req_method`, `req_url`, `req_header_map`, `req_body`, `req_body_bytes_used`, `executed_at`, `is_local`, `replicated_times`) SELECT `job_id`, `success`, `lock_nonce`, `response_id`, `response_error`, `req_method`, `req_url`, `req_header_map`, `req_body`, `req_body_bytes_used`, `executed_at`, `is_local`, `replicated_times` FROM `executions`;
